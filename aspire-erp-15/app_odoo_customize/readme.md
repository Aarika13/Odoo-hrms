...
This module can help to white label the Odoo. Also, helpful for training and support for your odoo end-user. The user
can get the help document just by one click.

15.0.1.0.1
----------
39376: Remove unnecessary options from User Login/Logout menu
