...
class tax_calculations(models.Model):
    ...
    employee_id = fields.Many2one('hr.employee',string="Employee" , domain="[('with_organization','=',True),('employee_no_type','=','permanent_employee')]")
    ...
    def calculate_it_declaration(self):
        active_employee_data = self.env['hr.employee'].search([('with_organization','=',True),('employee_no_type','=','permanent_employee')])
